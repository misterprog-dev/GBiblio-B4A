...
public class dashboard extends Activity implements B4AActivity{
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        mostCurrent = this;
		if (processBA == null) {
			processBA = new BA(this.getApplicationContext(), null, null, "b4a.sqlitelight1", "b4a.sqlitelight1.dashboard");
	...
	private void afterFirstLayout() {
        if (this != mostCurrent)
			return;
		activityBA = new BA(this, layout, processBA, "b4a.sqlitelight1", "b4a.sqlitelight1.dashboard");
        ...
        if (BA.isShellModeRuntimeCheck(processBA)) {
			...
			processBA.raiseEvent2(null, true, "CREATE", true, "b4a.sqlitelight1.dashboard", processBA, activityBA, _activity, anywheresoftware.b4a.keywords.Common.Density, mostCurrent);
...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 27;BA.debugLine="Activity.LoadLayout(\"Dashboard\")";
...
mostCurrent._imageview1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Private ImageView2 As ImageView";
mostCurrent._imageview2 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 19;BA.debugLine="Private ImageView3 As ImageView";
...
mostCurrent._imageview4 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Private ImageView5 As ImageView";
mostCurrent._imageview5 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 22;BA.debugLine="Private ImageView6 As ImageView";
...
public static String  _imageview1_click() throws Exception{
 ...
 //BA.debugLineNum = 65;BA.debugLine="StartActivity(addAdhe)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._addadhe.getObject()));
 //BA.debugLineNum = 66;BA.debugLine="End Sub";
return "";
}
public static String  _imageview2_click() throws Exception{
 //BA.debugLineNum = 60;BA.debugLine="Sub ImageView2_Click";
 //BA.debugLineNum = 61;BA.debugLine="StartActivity(GererAdh)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._gereradh.getObject()));
 //BA.debugLineNum = 62;BA.debugLine="End Sub";
return "";
}
public static String  _imageview3_click() throws Exception{
 //BA.debugLineNum = 56;BA.debugLine="Sub ImageView3_Click";
 //BA.debugLineNum = 57;BA.debugLine="StartActivity(addBook)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._addbook.getObject()));
 //BA.debugLineNum = 58;BA.debugLine="End Sub";
return "";
}
public static String  _imageview4_click() throws Exception{
 //BA.debugLineNum = 52;BA.debugLine="Sub ImageView4_Click";
 //BA.debugLineNum = 53;BA.debugLine="StartActivity(gererBook)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._gererbook.getObject()));
 //BA.debugLineNum = 54;BA.debugLine="End Sub";
return "";
}
public static String  _imageview5_click() throws Exception{
 //BA.debugLineNum = 48;BA.debugLine="Sub ImageView5_Click";
 //BA.debugLineNum = 49;BA.debugLine="StartActivity(Emprunt)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._emprunt.getObject()));
 //BA.debugLineNum = 50;BA.debugLine="End Sub";
return "";
}
public static String  _imageview6_click() throws Exception{
 //BA.debugLineNum = 44;BA.debugLine="Sub ImageView6_Click";
 //BA.debugLineNum = 45;BA.debugLine="StartActivity(Depot)";
anywheresoftware.b4a.keywords.Common.StartActivity(processBA,(Object)(mostCurrent._depot.getObject()));
